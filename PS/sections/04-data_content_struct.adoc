...
===== [start_review1]Meta Features[end_review1]
...
[reviewer=IIC,date=2025-12-05,from=start_review1,to=end_review1]
****
...
===== [start_review3]Simple attributes[end_review3]

The following table lists the types of simple attributes used in S-412.

[reviewer=IIC,date=2025-12-04,from=start_review3,to=end_review3]
****
