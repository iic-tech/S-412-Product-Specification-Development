...
image::../images/S-412-GFM.png[UML diagram depicting the S-412 General Feature Model]
...
These feature types are derived from the S-100_GF_FeatureType metaclass. Feature and information Ttype descriptions can be found in Annex A.
...
Examples illustrating the variety of ways geometry may be represented in an S-412 GML data file are provided in Annex C.
