...
This clause specifies the encoding for Marine Weather Warning datasets. The principal encoding is the Open Geospatial Consortium (OGC), Geography Markup Language (GML) format as profiled by the S-100 GML schema in Part 10b of S-100. Refer to the sample datasets for complete descriptions and examples of the data records, fiels and subfields defined in GML encoding.
