...
NOTE:: The following references are mentionned in addition to the list provided in Section 1 - Overview.
...
IHO S-158:: _Validation Checks – Introduction and Structure,_ Edition 1.0.0, February 2025
