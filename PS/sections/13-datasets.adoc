...
#WMO to consider if this section should be removed:#

*  #Dataset Coverage and Display Scale Range rules may not apply if Data Coverage feature is not used in S-412.#
*  #Geometry is already detailled in section 4.#
